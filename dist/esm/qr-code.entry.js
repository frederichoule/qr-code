import { r as registerInstance, c as createEvent, h, g as getElement } from './index-ba402efd.js';
...
const BpQRCode = class {
  constructor(hostRef) {
    ...
    this.codeRendered = createEvent(this, "codeRendered", 7);
    this.contents = '';
    this.protocol = '';
  ...
  get qrCodeElement() { return getElement(this); }
